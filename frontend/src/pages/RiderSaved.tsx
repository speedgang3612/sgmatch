...
/** 저장한 지사 목록 페이지 (준비 중) */
export default function RiderSaved() {
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex items-center justify-center">
      <div className="text-center max-w-md px-6">
        <div className="w-20 h-20 bg-[#E63946]/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
          <Heart size={40} className="text-[#E63946]" />
        </div>
        <h1 className="text-2xl font-bold mb-3">저장한 지사</h1>
        <p className="text-[#6B7280] mb-2">관심 지사를 저장하면 여기서 확인할 수 있습니다.</p>
